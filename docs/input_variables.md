...
[alpha_hybrid_rpa](#alpha_hybrid_rpa) 
...
[kappa_hybrid_rpa](#kappa_hybrid_rpa) 
[ncoreg](#ncoreg) 
[ncorew](#ncorew) 
...
Only works for RPA and its variants when using Hartree-Fock orbitals and energies to evaluate one-shot double-hybrid expressions.                                     Sets the amount of exact-echange. 
...
Only works for RPA and its variants when using Hartree-Fock orbitals and energies to evaluate one-shot double-hybrid expressions.                                     Sets the amount of Ec^RPA correlation. 
...
*Generated by input_variables.py on 19 April 2023* 
