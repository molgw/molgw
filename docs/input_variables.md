...
Maximum spacing between grid points in the real space FFT grid. Default is 0.15 bohr.
...
Renormalize the density at each SCF cycle to integrate to the expected nuclei and electron count.
