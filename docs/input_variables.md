...
Only works for Range-Separated hybrid functionals scf='rsh' Sets the amount of DFT correlation. 
...
Select the NOFT approx. to use (default= 'GNOF'). Other options are 'PNOF5', 'PNOF7', 'HF', 'MULLER', and 'POWER'. 
