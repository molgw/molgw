...
! Generated by input_variables.py on 17 April 2026
!======================================================================

  write(stdout, '(1x,a32,2x,"(",3(es16.8,2x),")")') 'a1', a1 
  write(stdout, '(1x,a32,2x,"(",3(es16.8,2x),")")') 'a2', a2 
  write(stdout, '(1x,a32,2x,"(",3(es16.8,2x),")")') 'a3', a3 
  ...
  write(stdout, '(1x,a32,6x,a)') 'analytic_chi', analytic_chi 
  write(stdout, '(1x,a32,6x,a)') 'approx_h_x2c', approx_h_x2c 
  ...
  write(stdout, '(1x,a32,6x,a)') 'bogoliubov_scf', bogoliubov_scf 
  write(stdout, '(1x,a32,2x,es16.8)') 'bogoliubov_sigma', bogoliubov_sigma 
  write(stdout, '(1x,a32,2x,es16.8)') 'c_speedlight', c_speedlight 
  ...
  write(stdout, '(1x,a32,6x,a)') 'complex_scf', complex_scf 
  write(stdout, '(1x,a32,6x,a)') 'cphf_cpks_0', cphf_cpks_0 
  ...
  write(stdout, '(1x,a32,2x,es16.8)') 'fft_coulomb_cutoff', fft_coulomb_cutoff 
  write(stdout, '(1x,a32,6x,a)') 'fft_coulomb_exchange', TRIM(fft_coulomb_exchange) 
  write(stdout, '(1x,a32,6x,a)') 'fft_coulomb_hartree', TRIM(fft_coulomb_hartree) 
  write(stdout, '(1x,a32,2x,es16.8)') 'fft_ecut', fft_ecut 
  write(stdout, '(1x,a32,2x,es16.8)') 'fft_ecut_postscf', fft_ecut_postscf 
  write(stdout, '(1x,a32,2x,i8)') 'fft_neighbors', fft_neighbors 
  write(stdout, '(1x,a32,6x,a)') 'fft_read_density', fft_read_density 
  write(stdout, '(1x,a32,6x,a)') 'fft_renormalize', fft_renormalize 
  write(stdout, '(1x,a32,6x,a)') 'force_energy_qp', force_energy_qp 
  write(stdout, '(1x,a32,6x,a)') 'frozencore', TRIM(frozencore) 
  write(stdout, '(1x,a32,6x,a)') 'g3w2_skip_vv', g3w2_skip_vv 
  write(stdout, '(1x,a32,6x,a)') 'g3w2_skip_vvv', g3w2_skip_vvv 
  write(stdout, '(1x,a32,6x,a)') 'g3w2_static_approximation', g3w2_static_approximation 
  ...
  write(stdout, '(1x,a32,6x,a)') 'harmonium', harmonium 
  ...
  write(stdout, '(1x,a32,6x,a)') 'noft_rsinter', noft_rsinter 
  write(stdout, '(1x,a32,2x,es16.8)') 'noft_tole', noft_tole 
  write(stdout, '(1x,a32,2x,i8)') 'nomega_chi_imag', nomega_chi_imag 
  write(stdout, '(1x,a32,2x,i8)') 'nomega_chi_real', nomega_chi_real 
  ...
  write(stdout, '(1x,a32,6x,a)') 'parabolic_conf', parabolic_conf 
  write(stdout, '(1x,a32,6x,a)') 'partition_scheme', TRIM(partition_scheme) 
  write(stdout, '(1x,a32,2x,es16.8)') 'pbe_plus_alpha', pbe_plus_alpha 
  write(stdout, '(1x,a32,6x,a)') 'poscar_file', TRIM(poscar_file) 
  ...
  write(stdout, '(1x,a32,2x,es16.8)') 'rwconfinement', rwconfinement 
  ...
  write(stdout, '(1x,a32,2x,es16.8)') 'scf_energy_shift', scf_energy_shift 
  ...
  write(stdout, '(1x,a32,2x,es16.8)') 'selfenergy_tdhf_alpha', selfenergy_tdhf_alpha 
  write(stdout, '(1x,a32,2x,es16.8)') 'selfenergy_tdhf_beta', selfenergy_tdhf_beta 
  ...
  write(stdout, '(1x,a32,6x,a)') 'w_screening', TRIM(w_screening) 
