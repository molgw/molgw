...
!======================================================================
 ...
 write(unit_yaml, '(4x,a,28x,"[",es16.8,", ",es16.8,", ",es16.8,"]")') 'a1:', a1 
 write(unit_yaml, '(4x,a,28x,"[",es16.8,", ",es16.8,", ",es16.8,"]")') 'a2:', a2 
 write(unit_yaml, '(4x,a,28x,"[",es16.8,", ",es16.8,", ",es16.8,"]")') 'a3:', a3 
 ...
 write(unit_yaml, '(4x,a,16x,a)') 'bogoliubov_scf:', yesno_to_TrueFalse(bogoliubov_scf) 
 write(unit_yaml, '(4x,a,14x,es16.8)') 'bogoliubov_sigma:', bogoliubov_sigma 
 ...
 write(unit_yaml, '(4x,a,12x,es16.8)') 'fft_coulomb_cutoff:', fft_coulomb_cutoff 
 write(unit_yaml, '(4x,a,10x,a)') 'fft_coulomb_exchange:', TRIM(fft_coulomb_exchange) 
 write(unit_yaml, '(4x,a,11x,a)') 'fft_coulomb_hartree:', TRIM(fft_coulomb_hartree) 
 write(unit_yaml, '(4x,a,22x,es16.8)') 'fft_ecut:', fft_ecut 
 write(unit_yaml, '(4x,a,14x,es16.8)') 'fft_ecut_postscf:', fft_ecut_postscf 
 write(unit_yaml, '(4x,a,17x,i8)') 'fft_neighbors:', fft_neighbors 
 write(unit_yaml, '(4x,a,14x,a)') 'fft_read_density:', yesno_to_TrueFalse(fft_read_density) 
 write(unit_yaml, '(4x,a,15x,a)') 'fft_renormalize:', yesno_to_TrueFalse(fft_renormalize) 
 write(unit_yaml, '(4x,a,15x,a)') 'force_energy_qp:', yesno_to_TrueFalse(force_energy_qp) 
 write(unit_yaml, '(4x,a,20x,a)') 'frozencore:', TRIM(frozencore) 
 ...
 write(unit_yaml, '(4x,a,21x,a)') 'noft_dft0:', yesno_to_TrueFalse(noft_dft0) 
 ...
 write(unit_yaml, '(4x,a,16x,es16.8)') 'pbe_plus_alpha:', pbe_plus_alpha 
 write(unit_yaml, '(4x,a,19x,a)') 'poscar_file:', TRIM(poscar_file) 
 ...
 write(unit_yaml, '(4x,a,13x,a)') 'print_bare_energy:', yesno_to_TrueFalse(print_bare_energy) 
 ...
 write(unit_yaml, '(4x,a,14x,es16.8)') 'scf_energy_shift:', scf_energy_shift 
 ...
 write(unit_yaml, '(4x,a,9x,es16.8)') 'selfenergy_tdhf_alpha:', selfenergy_tdhf_alpha 
 write(unit_yaml, '(4x,a,10x,es16.8)') 'selfenergy_tdhf_beta:', selfenergy_tdhf_beta 
