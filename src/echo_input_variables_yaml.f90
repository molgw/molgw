...
!======================================================================
 ...
 write(unit_yaml,'(4x,a,19x,a)') 'complexnoft:',yesno_to_TrueFalse(complexnoft) 
 ...
 write(unit_yaml,'(4x,a,23x,a)') 'fcidump:',yesno_to_TrueFalse(fcidump) 
 ...
 write(unit_yaml,'(4x,a,19x,i8)') 'iprintswdmn:',iprintswdmn 
 write(unit_yaml,'(4x,a,20x,i8)') 'iprintints:',iprintints 
 write(unit_yaml,'(4x,a,21x,i8)') 'ireadCOEF:',ireadCOEF 
 write(unit_yaml,'(4x,a,20x,i8)') 'ireadFdiag:',ireadFdiag 
 write(unit_yaml,'(4x,a,19x,i8)') 'ireadGAMMAS:',ireadGAMMAS 
 write(unit_yaml,'(4x,a,22x,i8)') 'ireadOCC:',ireadOCC 
 write(unit_yaml,'(4x,a,26x,i8)') 'ista:',ista 
 write(unit_yaml,'(4x,a,16x,i8)') 'ithresh_lambda:',ithresh_lambda 
 ...
 write(unit_yaml,'(4x,a,21x,a)') 'lowmemERI:',yesno_to_TrueFalse(lowmemERI) 
 write(unit_yaml,'(4x,a,24x,es16.8)') 'Lpower:',Lpower 
 write(unit_yaml,'(4x,a,19x,es16.8)') 'min_overlap:',min_overlap 
 write(unit_yaml,'(4x,a,17x,a)') 'mixing_scheme:',TRIM(mixing_scheme) 
 write(unit_yaml,'(4x,a,24x,i8)') 'npairs:',npairs 
 write(unit_yaml,'(4x,a,22x,i8)') 'ncoupled:',ncoupled 
 write(unit_yaml,'(4x,a,19x,i8)') 'npulay_hist:',npulay_hist 
 write(unit_yaml,'(4x,a,26x,i8)') 'nscf:',nscf 
 write(unit_yaml,'(4x,a,21x,i8)') 'ndiis_nof:',ndiis_nof 
 write(unit_yaml,'(4x,a,22x,i8)') 'nscf_nof:',nscf_nof 
 write(unit_yaml,'(4x,a,14x,a)') 'partition_scheme:',TRIM(partition_scheme) 
 write(unit_yaml,'(4x,a,19x,a)') 'restartnoft:',yesno_to_TrueFalse(restartnoft) 
 write(unit_yaml,'(4x,a,14x,a)') 'scf_diago_flavor:',TRIM(scf_diago_flavor) 
 write(unit_yaml,'(4x,a,22x,es16.8)') 'tolE_nof:',tolE_nof 
