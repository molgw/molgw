...
!======================================================================
 ...
 character(len=256), protected :: fft_coulomb_exchange
 character(len=256), protected :: fft_coulomb_hartree
 real(dp), protected :: fft_coulomb_cutoff
 real(dp), protected :: fft_ecut
 real(dp), protected :: fft_ecut_postscf
 integer, protected :: fft_neighbors
 character(len=3), protected :: fft_read_density
 logical, protected :: fft_read_density_
 character(len=3), protected :: fft_renormalize
 logical, protected :: fft_renormalize_
 ...
 character(len=3), protected :: bogoliubov_scf
 logical, protected :: bogoliubov_scf_
 real(dp), protected :: bogoliubov_sigma
 ...
 character(len=256), protected :: frozencore
 ...
 real(dp), protected :: selfenergy_tdhf_alpha
 real(dp), protected :: selfenergy_tdhf_beta
 ...
 real(dp), protected :: pbe_plus_alpha
 ...
 real(dp), protected :: scf_energy_shift
 ...
 real(dp), protected :: a1(3)
 real(dp), protected :: a2(3)
 real(dp), protected :: a3(3)
 ...
 character(len=256), protected :: poscar_file
