...
!======================================================================
 ...
 character(len=128),protected :: basis_path
 ...
 character(len=128),protected :: ci_greens_function
 integer,protected :: ci_nstate
 integer,protected :: ci_nstate_self
 integer,protected :: ci_spin_multiplicity
 character(len=128),protected :: ci_type
 real(dp),protected :: density_matrix_damping
 integer,protected :: dft_core
 real(dp),protected :: diis_switch
 character(len=128),protected :: ecp_auxil_basis
 character(len=128),protected :: ecp_basis
 character(len=128),protected :: ecp_elements
 character(len=128),protected :: ecp_quality
 character(len=128),protected :: ecp_small_basis
 character(len=128),protected :: ecp_type
 ...
 character(len=128),protected :: excit_name
 ...
 character(len=128),protected :: gaussian_type
 real(dp),protected :: grid_memory
 character(len=128),protected :: grid_quality
 character(len=3),protected :: gwgamma_tddft
 character(len=3),protected :: ignore_bigrestart
 character(len=3),protected :: incore
 character(len=128),protected :: init_hamiltonian
 character(len=128),protected :: integral_quality
 real(dp),protected :: kerker_k0
 character(len=128),protected :: length_unit
 ...
 character(len=128),protected :: mixing_scheme
 character(len=128),protected :: move_nuclei
 ...
 character(len=128),protected :: partition_scheme
 character(len=128),protected :: postscf
 character(len=128),protected :: postscf_diago_flavor
 character(len=128),protected :: pred_corr
 ...
 character(len=128),protected :: prop_type
 character(len=128),protected :: pt3_a_diagrams
 character(len=128),protected :: pt_density_matrix
 real(dp),protected :: r_disc
 real(dp),protected :: rcut_mbpt
 character(len=128),protected :: read_fchk
 character(len=3),protected :: read_tddft_restart
 integer,protected :: scalapack_block_min
 character(len=128),protected :: scf
 character(len=128),protected :: scf_diago_flavor
 ...
 character(len=128),protected :: xyz_file
