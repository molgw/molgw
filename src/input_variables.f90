...
!=====
 ...
 fft_coulomb_exchange = 'spherical'
 fft_coulomb_hartree = 'bare'
 fft_coulomb_cutoff = 0.0_dp 
 fft_ecut = 120.0_dp 
 fft_ecut_postscf = 99999.0_dp 
 fft_neighbors = 1
 fft_read_density = 'no'
 fft_renormalize = 'yes'
 gaussian_type = 'pure'
 ...
 selfenergy_tdhf_alpha = 0.0_dp 
 selfenergy_tdhf_beta = 0.0_dp 
 ...
 noft_restart = 'no'
 noft_tolE = 1e-09_dp 
 a1 = (/ 0.0_dp , 0.0_dp , 0.0_dp /)
 a2 = (/ 0.0_dp , 0.0_dp , 0.0_dp /)
 a3 = (/ 0.0_dp , 0.0_dp , 0.0_dp /)
 charge = 0.0_dp 
