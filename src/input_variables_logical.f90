...
bogoliubov_scf_ = yesno_to_logical(bogoliubov_scf)
...
fft_read_density_ = yesno_to_logical(fft_read_density)
fft_renormalize_ = yesno_to_logical(fft_renormalize)
...
noft_dft0_ = yesno_to_logical(noft_dft0)
...
print_bare_energy_ = yesno_to_logical(print_bare_energy)
...
print_molden_ = yesno_to_logical(print_molden)
...
print_transition_dipole_ = yesno_to_logical(print_transition_dipole)
