...
subroutine gwtilde_selfenergy(basis,occupation,energy,c_matrix,se)
  ...
  write(stdout,*) "**********    GWTIDLE BRUNEVAL-FOERSTER   ****************************"
  ...
  call destroy_eri_3center_eigen()
  call wpol%destroy()
  write(stdout,*) "**********    GWTIDLE BRUNEVAL-FOERSTER  *** THE END ****************"
  call stop_clock(timing_gw_self)
...
!=========================================================================
subroutine gwtilde_selfenergy3(basis,occupation,energy,c_matrix,se)
  implicit none
...
end subroutine gwtilde_selfenergy3
