...
!=========================================================================
function lbfgs_wrapper(xi,ff,gradf) RESULT(info)
...
!=====
 ...
 if( SIZE(xi) /= SIZE(gradf) ) call die('lbfgs_wrapper: dimension error')
...
!=====
 ...
 if(ALLOCATED(work_lbfgs)) deallocate(work_lbfgs)
