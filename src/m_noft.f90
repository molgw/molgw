...
!=====
 ...
 Enoft = zero
 nstate = SIZE(c_matrix,DIM=2) ! Number of lin. indep. molecular orbitals
...
!=====
 ...
 nstate = nbf  !FB2MARM: in your coding, it seems that nstate means nbf. For instance NO_COEF is nbf x nbf, hCORE is nbf x nbf as well
