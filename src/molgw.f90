...
!   call full_ci_2electrons_selfenergy(occupation)
   ...
   call full_ci_3electrons_on(.TRUE.,nstate,1,basis,hamiltonian_kinetic+hamiltonian_nucleus,c_matrix,en%nuc_nuc)
   call full_ci_4electrons_on(.TRUE.,nstate,0,basis,hamiltonian_kinetic+hamiltonian_nucleus,c_matrix,en%nuc_nuc)
   call full_ci_5electrons_on(.TRUE.,nstate,1,basis,hamiltonian_kinetic+hamiltonian_nucleus,c_matrix,en%nuc_nuc)
