...
fbp.write('!\n')
fbp.write('! The following lines have been generated by the python script `prepare_sourcecode.py`\n')
...
frev.write('!\n')
frev.write('! The following lines have been generated by the python script `prepare_sourcecode.py`\n')
