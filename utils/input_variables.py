...
#================================
vl.append(variable())
vl[-1].keyword  ='nvirtualspa'
vl[-1].family   ='post'
vl[-1].default  =100000
vl[-1].datatype ='integer'
vl[-1].comment  ='Sets the starting state beyond which states are accounted for with a Single Pole Approximation for the screened Coulomb interaction W for GW.'
