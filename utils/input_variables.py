...
#============================================================================
#            Fortran output: input variable namelist, and input variable default value
#============================================================================
...
#============================================================================
#            Fortran output: interpreting yes/no to fortran logical
#============================================================================

print(f"Setting up file: {path}/src/input_variables_logical.f90")
ffor = open(path + '/src/input_variables_logical.f90', 'w')

ffor.write(header)

for key, value in sorted_var_dict.items():
  if 'yes' in value['datatype']:
    key_modif = key + '_'
    ffor.write(f'{key_modif} = yesno_to_logical({key})\n')
